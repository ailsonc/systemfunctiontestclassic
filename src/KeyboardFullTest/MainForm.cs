    ...
    public partial class MainForm : Form
    {
        ...
        void _listener_OnKeyPressed(object sender, KeyPressedArgs e)
        {
            ...
            switch (keycode)
            {
                ...
                case "HotKey2":
                    Log.LogStart($"OnKeyPressed: {keycode}");
                    this.PrimeVideo.BackColor = (this.PrimeVideo.BackColor == Color.Green ? Color.Red : Color.Green);
                    CheckPass();
                    break;
                case "HotKey3":
                    Log.LogStart($"OnKeyPressed: {keycode}");
                ...
                case "HotKey4":
                    Log.LogStart($"OnKeyPressed: {keycode}");
                    this.MultPlus.BackColor = (this.MultPlus.BackColor == Color.Green ? Color.Red : Color.Green);
                    CheckPass();
                    break;
                case "HotKey5":
                    Log.LogStart($"OnKeyPressed: {keycode}");
