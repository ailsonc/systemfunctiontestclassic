...
namespace FormsBrightness
{
    public partial class FormBrightness : Form
    {
        ...
        private void _ThreadFunction()
        {
            ...
            SafeSetVisible(PassBtn, true);
            SafeSetVisible(FailBtn, true);
            SafeSetVisible(RetryBtn, true);
        ...
        private void SafeSetVisible(Control c, bool isfVisible)
        {
            if (this.InvokeRequired)
            {
                Invoke(new MethodInvoker(delegate () {
                    SafeSetVisible(c, isfVisible);
                }));
            }
            else
            {
                c.Visible = isfVisible;
            }
        }
    }
}
