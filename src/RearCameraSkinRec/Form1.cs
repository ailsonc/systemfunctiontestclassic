...
namespace FrontCameraSkin
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            this.Text = LocRM.GetString("RearCameraRec");
            Playbtn.Text = LocRM.GetString("Pass");
            FailBtn.Text = LocRM.GetString("Fail");
            ResetBtn.Text = LocRM.GetString("Retry");
            InstructionLbl.Text = LocRM.GetString("RearCameraRecHint");
        ...
        void CameraTest()
        {
            ...
            string Camera_filename = "RearCameraRec.exe";
