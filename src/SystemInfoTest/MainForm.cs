...
namespace SystemInfoTest
{
    public partial class MainForm : Form
    {
        ...
        {
            Title.Text = LocRM.GetString("Informações") + LocRM.GetString("Test");
            PassBtn.Text = LocRM.GetString("Passou");
            FailBtn.Text = LocRM.GetString("Falha");
        }

        private void RamLbl_Click(object sender, EventArgs e)
        {
